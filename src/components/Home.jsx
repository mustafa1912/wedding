                                                                ...
                                                                <div className="col-sm-6 col-md-3 col-lg-2 p-2" key={index}>
                                                                    {index < 6 ?
                                                                        <div className="wpo-about-item-s2 mb-2">
                                                                            <div className="wpo-about-img" >
                                                                                <div className="bg-img-portfolio" style={{ backgroundImage: `url('http://localhost/livewire-master/storage/app/public/${Element.image}')` }}></div>
                                                                            </div>
                                                                        </div> : ''}
                                                                </div>
                                                            ))}
